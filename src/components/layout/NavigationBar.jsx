  ...
  return (
    <nav className="navigation-bar" aria-label="Menú principal">
      <ul>
        ...
        <li>
          <Link to="/products" aria-label="Ver todos los productos">Productos</Link>
        </li>
        ...
        <li>
          <Link to="/brands" aria-label="Explorar por marcas">Marcas</Link>
        </li>
        <li>
          <Link to="/contact" aria-label="Contactar con nosotros">Contacto</Link>
        </li> 
      </ul>
    </nav>
  );
